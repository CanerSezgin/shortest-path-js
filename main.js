...
function startEndTiles(extPoints){
    ...
    $(`#${tiles[points.startIndex].row}_${tiles[points.startIndex].col}`).addClass('starting').html('S')
    tiles[points.endIndex].property = 'end';
    $(`#${tiles[points.endIndex].row}_${tiles[points.endIndex].col}`).addClass('ending').html('F')
